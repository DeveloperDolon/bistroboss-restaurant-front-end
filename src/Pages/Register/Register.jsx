                ...
                <div className="">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="grid grid-cols-1 gap-6 mt-8">
                        ...
                        <label className="text-lg font-semibold" htmlFor="email">Password
                            <input {...register("password", {required: true, maxLength: 20, minLength: 6, pattern: /(?=.*[A-Z])(?=.*[!@#$&*])(?=.*[0-9])(?=.*[a-z])/, })} className="text-base font-normal w-full py-5 pl-7 rounded-md mt-3" type="text" placeholder="Type name" />
